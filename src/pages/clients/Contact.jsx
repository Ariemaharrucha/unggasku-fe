          ...
          <div className="bg-yellow-400 rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="p-8 bg-yellow-400 md:w-1/2">
              <form>
                <form>
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text"  className="p-3 border border-gray-300 rounded w-full" />
                    </div>
                    <div>
                    ...
                    <div className="col-span-2">
                      ...
                      <input type="email"  className="p-3 border border-gray-300 rounded w-full" />
                    </div>
                    <div className="col-span-2">
                ...
                <textarea placeholder="Tulis pesan anda..." className="p-2 mt-4 w-full border border-gray-300 rounded h-20"></textarea>
...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="border-b py-3">
      ...
      {open && <p className="mt-2 text-gray-600 text-xl">{answer}</p>}
    </div>
  );
};
