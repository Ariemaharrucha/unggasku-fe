...
const artikel = [
  {
    _id: "11",
    judul: "kenapa ayam",
    images: "https://i.pinimg.com/474x/d9/b2/b9/d9b2b9480c1e6ee25c6bbd046a78533a.jpg",
  ...
  },
  {
    _id: "11",
    judul: "kenapa ayam",
    images: "https://i.pinimg.com/474x/df/1c/2e/df1c2e9da37bda778f82127e96103e53.jpg",
    teks: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo, quam alias. Nostrum iure assumenda possimus obcaecati voluptatibus minima, quos aut debitis temporibus eos velit excepturi recusandae consectetur enim rem dolorem!",
    tanggal: "02-06-2004",
  },
];
              ...
              {artikel.map((artikel, index) => (
                <tr key={artikel._id} className="border-b bg-white">
                  ...
                  <td className="px-6 py-4 overflow-hidden">
                    <img src={artikel.images} alt=""className="w-full h-full" />
                  </td>
                  <td className="block w-96 px-6 py-4">{artikel.teks}</td>
