...
import { ArtikelPage } from "../pages/clients/ArtikelPage";
import { ArtikelDetails } from "../pages/clients/ArtikelDetails";
...
import { ArtikelOverview } from "../pages/dashboard/ArtikelOverview";
import { FormAddArtikel } from "../pages/dashboard/FormAddArtikel";
import { FormEditArtikel } from "../pages/dashboard/FormEditArtikel";
import { DokterOverview } from "../pages/dashboard/DokterOverview";
import { FormAddDokter } from "../pages/dashboard/FormAddDokter.jsx"; 
...
export const AppRouter = () => {
  ...
  <BrowserRouter>
    <Routes>
      ...
      <Route path="/dashboard/dokter/create" element={<FormAddDokter/>}></Route>
    </Routes>
  </BrowserRouter>
  )
};
